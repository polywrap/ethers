...
pub trait SyncSignerMiddleware<M: Middleware, S: Signer> {
...
impl SyncSignerMiddleware<Provider<PolywrapProvider>, PolywrapSigner> for SignerMiddleware<Provider<PolywrapProvider>, PolywrapSigner> {
